        ...
        <form name="sentMessage"  method="post">
            <div class="control-group form-group">
                <div class="controls">
                    <label>Full Name:</label>
                     <input type="text" class="form-control" id="name" name="fullname"  pattern="[A-Za-z]+" placeholder="enter the full name" required>
            ...
            <div class="control-group form-group">
                <div class="controls">
                    ...
                    <input type="text" name="contactno" placeholder="enter the mobile number" maxlength="10" pattern="[0-9]{10}" class="form-control" required="true">
            ...
            <div class="control-group form-group">
                <div class="controls">
                    <label>Message:</label>
                     <textarea rows="8" cols="100" class="form-control" id="message" name="message" required  maxlength="999" style="resize:none"></textarea>
